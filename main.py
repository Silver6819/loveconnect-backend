...
@app.get("/")
async def home():
    # Construcción de las burbujas y la sala de castigo
    mensajes_html = "".join([
    ...
    <head>
        ...
        <style>
            ...
            .punish-room {{ 
                background:#2b2b2b; color:#bbb; border-radius:20px; 
                padding:12px; margin:10px 0; font-style:italic; 
                text-align:center; box-shadow:inset 0 0 8px #000; font-size:13px;
            }}
            ...
            .clear-btn {{ 
                ...
                border-radius:12px; margin:8px auto; cursor:pointer; font-size:13px; display:block;
            }}
    ...
    <body>
        <div class="container">
            <header>
                💖 LoveConnect
                <a href="{OBRA_URL}" class="logout" title="Salir">⎋</a>
            </header>
