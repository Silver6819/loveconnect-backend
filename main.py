            ...
            <script>
                ...
                function processImage() {{
                    ...
                    reader.onload = function(e) {{
                        ...
                        img.onload = function() {{
                            ...
                            const MAX_WIDTH = 400; // Reducimos la foto para que no pese nada
                            let width = img.width;
                ...
                async function enviarDatos() {{
                    ...
                    try {{
                        ...
                        else {{ alert("Error: El nombre ya existe."); btn.disabled = false; btn.innerHTML = "Verificar y Registrar"; }}
    ...
    for r in rows:
        ...
        <div class="card" style="display:flex; align-items:center; gap:15px; text-align:left;">
            ...
            <div>
                ...
                <small style="color:#2ecc71;"><span class="status-dot"></span>En línea</small>
            </div>
        </div>"""
    return f"<html><head><meta name='viewport' content='width=device-width, initial-scale=1'>{ESTILOS}</head><body><div style='max-width:500px; margin:auto;'><h1>💖 Comunidad LoveConnect</h1>{cartas}<a href='/' class='btn' style='background:#bbb;'>Volver al Registro</a></div></body></html>"
