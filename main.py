    ...
    <style>
        * {{ box-sizing: border-box; -webkit-tap-highlight-color: transparent; }}
        ...
        .s {{ 
            ...
            min-width: 80px; height: 45px; cursor: pointer; font-size: 16px; 
            font-weight: bold; box-shadow: 0 4px #c2185b; transition: 0.1s;
        }}
...
<body>
    ...
    <div class="u">
        ...
        <button type="button" class="s" onmousedown="if(!ws||ws.readyState!==1)co()" onclick="sd()">ENVIAR</button>
    </div>
    <div class="n">
...
@app.websocket("/ws/{{u}}")
async def websocket_endpoint(websocket: WebSocket, u: str):
