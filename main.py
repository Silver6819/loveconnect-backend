...
<body>
    <div id="l">
        ...
        <input type="text" id="un" placeholder="Tu Nombre" style="max-width:200px; margin-bottom:15px; padding:10px;">
        <button onclick="st()" style="background:#FF4081; color:white; border:none; padding:10px 30px; border-radius:20px;">ENTRAR</button>
    </div>
